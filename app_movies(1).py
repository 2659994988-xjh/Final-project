...
search_type = st.sidebar.radio("Search Types", ["Director", "Star"])
...
ax1.set_ylabel("Average Budget (Million $)", fontsize=12, color='#1f77b4')
...
ax2.set_ylabel("Average Box Office (Million $)", fontsize=12, color='#ff7f0e')
